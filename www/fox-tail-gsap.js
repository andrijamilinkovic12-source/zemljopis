(() => {
    ...
    timeline
        ...
        .to(tails, { rotation: -2.1, duration: 0.45, ease: 'sine.inOut', force3D: false })
        .to(tails, { rotation: -4, duration: 0.58, ease: 'sine.inOut', force3D: false })
        .to(tails, { rotation: -1.1, duration: 0.52, ease: 'sine.inOut', force3D: false })
        .to(tails, { rotation: -3, duration: 0.48, ease: 'sine.inOut', force3D: false })
